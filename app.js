...
const pointers = process.argv.slice(2);
const command = pointers[0];
const action1 = pointers[1];
const action2 = pointers[2];
const action3 = pointers[3];
const action4 = pointers[4];
